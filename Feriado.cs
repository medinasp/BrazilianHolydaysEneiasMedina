using BrazilianHolidaysEneiasMedina.Helpers;

namespace BrazilianHolidaysEneiasMedina
{
    /// <summary>
    ...
    public class Feriado
        {
            ...
            private Feriado(int anoFeriado)
            {
                if (AnoFeriado != anoFeriado)
                {
                    ...
                    _feriados.Sort((FeriadoCelebrado x, FeriadoCelebrado y) => DateTime.Compare(x.DataFeriado, y.DataFeriado));
                }
            ...
            private FeriadoCelebrado ObterSegundaDeCarnaval(DateTime domingoDePascoa)
            {
                ...
                if (domingoDePascoa != erro)
                {
                    ...
                    feriado = FeriadoCelebrado.CriarFeriado(segundaFeiraDeCarnaval, descricao, abrangencia, pais, estado, codigoFederal, codigoIbge, nomeMunicipio, true, true);
                }
            ...
            private FeriadoCelebrado ObterTercaDeCarnaval(DateTime domingoDePascoa)
            {
                ...
                if (domingoDePascoa != erro)
                {
                    ...
                    feriado = FeriadoCelebrado.CriarFeriado(tercaFeiraDeCarnaval, descricao, abrangencia, pais, estado, codigoFederal, codigoIbge, nomeMunicipio, true, true);
                }
            ...
            private FeriadoCelebrado ObterQuartaDeCinzas(DateTime domingoDePascoa)
            {
                ...
                if (domingoDePascoa != erro)
                {
                    ...
                    feriado = FeriadoCelebrado.CriarFeriado(quartaDeCinzas, descricao, abrangencia, pais, estado, codigoFederal, codigoIbge, nomeMunicipio, true, true);
                }
            ...
            private FeriadoCelebrado ObterSextaSanta(DateTime domingoDePascoa)
            {
                ...
                if (domingoDePascoa != erro)
                {
                    ...
                    feriado = FeriadoCelebrado.CriarFeriado(sextaSanta, descricao, abrangencia, pais, estado, codigoFederal, codigoIbge, nomeMunicipio, false, true);
                }
            ...
            private FeriadoCelebrado ObterDomingoPascoa(DateTime domingoDePascoa)
            {
                ...
                if (domingoDePascoa != erro)
                {
                    ...
                    feriado = FeriadoCelebrado.CriarFeriado(domingoDePascoa, descricao, abrangencia, pais, estado, codigoFederal, codigoIbge, nomeMunicipio, false, true);
                }
            ...
            private FeriadoCelebrado ObterCorpusChristi(DateTime domingoDePascoa)
            {
                ...
                if (domingoDePascoa != erro)
                {
                    ...
                    feriado = FeriadoCelebrado.CriarFeriado(quintaCorpusChristi, descricao, abrangencia, pais, estado, codigoFederal, codigoIbge, nomeMunicipio, false, true);
                }
            ...
            ///<summary>
            /// Retorna uma lista com os feriados móveis adicionado aos nacionais fixos
            /// </summary>
            /// <param name="anoFeriado"></param>
            /// <param name="pais"></param>
            /// <returns></returns>
            public IReadOnlyCollection<FeriadoCelebrado> FeriadosMoveis(int anoFeriado, string pais = _brasil)
            {
                FeriadoCelebrado[] feriados;
                ...
                {
                    Feriado feriado = Factory(anoFeriado);
                    feriados = feriado._feriados.Where(feriado => feriado.Pais == pais && feriado.Abrangencia == _nacional && feriado.DataFeriado.Month != 12).ToArray();
                    feriado.Dispose();
                }
                else
                {
                    feriados = _feriados.Where(feriado => feriado.Pais == pais && feriado.Abrangencia == _nacional && feriado.DataFeriado.Month != 12).ToArray();
                }
