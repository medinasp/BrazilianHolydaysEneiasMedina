namespace BrazilianHolidaysEneiasMedina
{
    ...
    public class FeriadoCelebrado
    {
        ...
        /// <summary>
        /// Nome do Município, composto 7 digitos numéricos.
        /// </summary>
        ...
        private FeriadoCelebrado(DateTime dataFeriado, string descricao, string abrangencia, string pais, string estado, string codigoFederalMunicipio, string codigoIbgeMunicipio, string nomeMunicipio, bool pontoFacultativo, bool feriadoMovel)
        {
        ...
        /// <param name="nomeMunicipio">Nome que identifica o Município.</param>
        ...
        public static FeriadoCelebrado CriarFeriado(DateTime dataFeriado, string descricao, string abrangencia, string pais, string estado, string codigoFederalMunicipio, string codigoIbgeMunicipio, string nomeMunicipio, bool pontoFacultativo, bool feriadoMovel)
        {
            return new FeriadoCelebrado(dataFeriado, descricao, abrangencia, pais, estado, codigoFederalMunicipio, codigoIbgeMunicipio, nomeMunicipio, pontoFacultativo, feriadoMovel);
        }
        ...
        public override bool Equals(object obj)
        {
            return obj is FeriadoCelebrado celebrado &&
                   ...
                   NomeMunicipio == celebrado.NomeMunicipio &&
